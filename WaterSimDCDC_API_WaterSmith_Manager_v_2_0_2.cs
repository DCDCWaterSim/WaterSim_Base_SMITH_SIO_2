...
//        int _waterManagementStart = 2016;
        ...
        public const int FNumberOfStates = 15;
        public static string[] FStateNames = new string[FNumberOfStates] { "Florida", "Idaho", "Illinois", "Minnesota", "Wyoming", "Arizona", "Colorado", "Nevada", "California", "Utah", "NewMexico","Alabama","Kansas", "Tennessee", "Virginia" };
