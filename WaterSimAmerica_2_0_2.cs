...
namespace WaterSimDCDC
{
    public class WaterSimAmerica
    {
        ...
        public WaterSimAmerica(string DataDirectoryName, string TempDirectoryName)
        {
            ...
            //StateData = "Just15StatesLakeNoRuralPower.csv";
            StateData = "Just15StatesLakeNoRuralPower.csv";
            //string rates = "ElevenStateGrowthRates.csv"; ; // string rates = "ElevenStateGrowthRates.csv";  //  String IndustryData = "ElevenStateAnnualIndGrowthRates.csv";
            string rates = "USGSSevenStateCountyWaterUse_031017.csv";
        ...
        public void ResetVariables()
        {
            ...
            seti_IndustryConservation(temp);
            invokeEffluent = true;
        }
        #endregion
        //
        ...
        void surfaceFresh()
        {
            ...
            double temp = 0;
            int result = 0;
            SurfaceWaterControl=moderateSurfaceWater(SurfaceWaterControl, geti_SurfaceWaterFresh());
            temp = geti_SurfaceWaterFresh() * SurfaceWaterControl;          
            if (startDroughtYear <= currentYear)
                temp = geti_SurfaceWaterFresh() * SurfaceWaterControl * Drought;// d_drought; //Drought
        ...
        void surfaceLake()
        {
            double temp = 0;
            int result = 0;
            temp = geti_SurfaceLake() * LakeWaterControl;
            result = Convert.ToInt32(temp);
        ...
        void groundwater()
        {
            double temp = 0;
            int result = 0;
            GroundWaterControl = moderateGroundwater(GroundWaterControl, geti_Groundwater());
            temp = geti_Groundwater() * GroundWaterControl;
            result = (int)temp;
        ...
        #endregion
        // ---------------------------------------------------------------------------------------------
        double moderateSurfaceWater(double sentValue, double resource)
        {
            double temp = 0;
            double ratio = 0;
            double T = Math.Pow(monitorDrought,2);
            ratio = resource / totalResources();
            temp = Math.Min(sentValue, 1 + Math.Pow(((double)sentValue * (1 - ratio)), T));     
            return temp;
        }
        //
        double moderateGroundwater(double sentValue, double resource)
        {
            double temp = 0;
            double ratio = 0;
            double T = 1;
        ...
        //
        double GroundWaterControl
        {
            get { return d_groundwaterControl; }
            set {d_groundwaterControl = value;}
        }
        double SurfaceWaterControl
        {
            get { return d_surfaceWaterControl; }
            set { d_surfaceWaterControl = value; }
        }
        double LakeWaterControl
        {
            get { return d_lakeWaterManagement; }
            set { d_lakeWaterManagement = value; }
        }
        ...
        public int Calc_IndDemand(int theCurrentYear, int theStartYear, double modDemand)
        {
            ...
            double useValue = 1.2;
            //double modValue = 0.43;
            double modValue = 0.35;
            ...
            try
            {
                ...
                //if (modDemand < 1) modDemand = correctMod(modDemand); 04.10.17 why did I have this code activated? DAS
        ...
        {
             //geti_TotalSupplies() an int that contains total supplies
            //double temp = WSA.SurfaceFresh.Limit + WSA.SurfaceLake.Limit + WSA.SurfaceSaline.Limit + WSA.Groundwater.Limit ;
            double temp = (double)geti_TotalSupplies();
            return temp;
        }
        double totalDeficit()
        {
            double temp = (double)geti_TotalDeficit();
            return temp;
        }
        ...
        // ============================================
        public int geti_TotalDeficit()
        {
            int result = 0;
            double temp = TheCRFNetwork.Urban.Net;
            temp += TheCRFNetwork.Agriculture.Net;
            temp += TheCRFNetwork.Power.Net;
            temp += TheCRFNetwork.Industrial.Net;
            try
            {
                int tempint = Convert.ToInt32(Math.Round(temp));
                result = tempint;
        ...
        ///
        /// <returns>an int from zero to 4 - used as a scenario preset (not used). </returns>
        ///--------------------------------------------------------------
        //double d_drought = 1.00;
        //double d_droughtManagement = 0.00;
        //public int geti_DroughtImpacts()
        //{
        //    int TempInt = Convert.ToInt32(DroughtManagement);
        //    return TempInt;
        //}
        /////------------------------------------------------------------------
        ...
        //{
        //    DroughtManagement = value;
        //}
        //public double DroughtManagement
        //{
        //    get { return d_droughtManagement; }
        //    set { d_droughtManagement = value; }
        //}
        ...
        {
            int temp = Convert.ToInt32(Math.Round(UrbanConservation * 100));
            return temp;
        }
        ///------------------------------------------------------------------
        ...
        {
            UrbanConservation = (Double)value / 100;
        }
        public double UrbanConservation
        {
            get { return d_urbanConservation; }
            set { d_urbanConservation = value; }
        }
        //
        // Desalinaiton
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(Desalinization * 100));
            return TempInt;
        }
        public void seti_Desalinization(int value)
        {
            Desalinization = (Double)value / 100;
        }
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(AgConservation * 100));
            return TempInt;
        }
        ///------------------------------------------------------------------
        /// <summary>   Seti UrbanConservation.</summary>
        ...
        {
            AgConservation = (Double)value / 100;
        }
        public double AgConservation
        {
            get { return d_agConservation; }
            set { d_agConservation = value; }
        }
        // =====================================================================
        // ============================================
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(PowerConservation * 100));
            return TempInt;
        }
        ///------------------------------------------------------------------
        /// <summary>   Seti UrbanConservation.</summary>
        ...
        {
            PowerConservation = (Double)value / 100;
        }
        public double PowerConservation
        {
            get { return d_powerConservation; }
            set { d_powerConservation = value; }
        }
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(IndustryConservation * 100));
            return TempInt;
        }
        double IndustryConservation
        {
            get { return d_industryConservation; }
            set { d_industryConservation = value; }
        }
        ///------------------------------------------------------------------
        /// <summary>   Seti UrbanConservation.</summary>
        ///
        ...
        {
            IndustryConservation = (Double)value / 100;
        }
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(GroundWaterControl * 100));
            return TempInt;
        }
        ...
        {
            GroundWaterControl = ((double)value) / 100;
        }
        //
        // =====================================================================
        // ============================================
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(SurfaceWaterControl * 100));
            return TempInt;
        }
        ///------------------------------------------------------------------
        ...
        {
            SurfaceWaterControl = ((double)value) / 100;
        }
        // =====================================================================
        // ===================================
        ...
        {
            int TempInt = Convert.ToInt32(Math.Round(LakeWaterControl * 100));
            return TempInt;
        }
        // ------------------------------------------------
        public void seti_LakeWaterManagement(int value)
        {
            LakeWaterControl = (double)value / 100;
        ...
        {
            int TempInt = Convert.ToInt32(Drought * 100);
            return TempInt;
        }
        public void seti_DroughtControl(int value)
        {
            Drought = ((double)value) / 100;
        }
        double Drought
        {
            get { return d_drought; }
            set { d_drought = value; }
        }
        // ================================================================================
        // Sustainability
